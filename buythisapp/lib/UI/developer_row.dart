...
class DeveloperRow extends StatelessWidget {
  ...
  static opus(Color backgroundColor, Color textColor) {
  ...
  static opusDark(Color backgroundColor, Color textColor) {
    DeveloperRow developerRow = DeveloperRow(backgroundColor, textColor);
    developerRow.developer = "https://opuslab.works/";
  ...
  static verbose(Color backgroundColor, Color textColor) {
    DeveloperRow developerRow = DeveloperRow(backgroundColor, textColor);
  ...
  static verboseDark(Color backgroundColor, Color textColor) {
    DeveloperRow developerRow = DeveloperRow(backgroundColor, textColor);
    developerRow.developer = "https://verbosetechlabs.com/";
